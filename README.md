...
**Expense Tracker** was developed as a collaborative team project to practice modern frontend development. The goal was to build a real-world financial tracking application focusing on:
...
*   **Spend Analysis:** Clear overview of financial habits through category-based breakdowns.
